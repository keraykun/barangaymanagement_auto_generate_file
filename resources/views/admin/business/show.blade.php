...
<div class="mb-5" id="testMe">
    <div>
        <a class="py-2 px-3 bg-blue-500 text-white" href="{{ route('admin.residentlist.detail',$business->id) }}">Back</a>
    </div>
    <div class="w-full flex items-center justify-center gap-3" >
            ...
            <div class="bg-white w-[100%] flex flex-col gap-5 py-3 px-1"  id="contentToPrint">
                <section class="flex justify-center items-center gap-3">
                    ...
                    <article class="text-lg text-center">
                        ...
                        <p>Province of {{ $business->district->barangay->municipal->province->name }} Municipality of {{ $business->district->barangay->municipal->name }}</p>
                        <p class="font-bold">BARANGAY {{ Str::upper($business->district->barangay->name) }}</p>
                        ...
                        <section class="text-center flex flex-col gap-4  font-bold  items-center justify-center">
                          ...
                          <section class="py-1 flex flex-col gap-4 text-md">
                            ...
                            <article class="text-lg" id="content">
                                ...
                                {{-- <p>
                                    <span>TYPE OF BUSINESS</span><span class="font-bold">{{ $business->firstname.' '.$business->middlename.' '.$business->lastname.' ' }}</span>, of legal age, married, Filipino citizenand resident of {{ $business->district->name }} Barangay {{ $business->district->barangay->name }}, {{ $business->district->barangay->municipal->name }}.
                                </p> --}}
                                <p>
                                ...
                                <p>
                                    <span style="margin-right: 32px;">NAME OF BUSINESS</span><span class="font-bold"> :  <span contentEditable="true">[ Store Name ]</span></span>
                                </p>
                                <p>
                                    <span style="margin-right: 20px;">NAME OF APPLICANT</span><span class="font-bold"> : <span contentEditable="true">{{  $business->firstname.' '.$business->middlename.' '.$business->lastname}}</span></span>
                                </p>
                                <p contentEditable="true">
                                    Which operating a business at Barangay {{ $business->district->barangay->name  }} , {{ $business->district->barangay->municipal->name  }} {{ $business->district->barangay->municipal->province->name  }} has undergone identification process and its operation conforms with the existing laws, rules, and regulation of the Barangay ( BARANGAY TAX REVENUE )
                                </p>
                                <br>
                                <p contentEditable="true">
                        ...
                        <section class="pb-2 pt-[40px]  items-start flex flex-col text-md" style="font-family:pacifico;">
                            ...
                            <div class="flex flex-col items-center">
                                <span class="w-full flex flex-row">
                                    ...
                                    <span>: <span contentEditable="true" id="amountPaid" data-user="{{ $business->id }}">P 500 pesos</span></span>
                                </span>
                                <span class="w-full flex flex-row">
                                ...
                                <span class="w-full flex flex-row">
                                    ...
                                    <span>: <span contentEditable="true">Barangay {{ $business->district->barangay->name  }} , {{ $business->district->barangay->municipal->name  }} {{ $business->district->barangay->municipal->province->name  }}</span></span>
                                </span>
                            </div>
                        </section>
                     </div>
        ...
        {{-- <a class="py-2 px-3 bg-blue-400 text-2xl rounded-md" href="{{ route('admin.indigency.show',$business->id) }}">print</a> --}}
        <div class="flex flex-col gap-5">
            <button class="py-2 px-3 bg-green-600 text-white rounded-md shadow-md" id="{{ $business->id }}" onclick="printDiv(this)">Print</button>
