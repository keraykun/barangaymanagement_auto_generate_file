...
<div class="mb-5" id="testMe">
    <div>
        <a class="py-2 px-3 bg-blue-500 text-white" href="{{ route('admin.business.list',$resident->id) }}">Back</a>
    </div>
                        ...
                        <section class="pb-2 pt-[40px]  items-start flex flex-col text-md" style="font-family:pacifico;">
                            ...
                            <div class="flex flex-col items-center">
                                <span class="w-full flex flex-row">
                                    ...
                                    <span>: <span contentEditable="true" id="amountPaid" data-user="{{ $resident->id }}">{{ $business->price }}</span></span>
                                </span>
                                <span class="w-full flex flex-row">
                                    <span style="margin-right: 38px;">Date of Issuance</span>
                                    <span>: <span contentEditable="true" id="issuanceDate">{{ $business->issuance_of }}</span></span>
                                </span>
                                <span class="w-full flex flex-row">
