...
<div class="mb-4">
    <a class="px-3 py-2 bg-white text-black shadow-2xl" href="{{ route('admin.residentlist.index') }}">Back</a>
</div>
...
<div class="relative overflow-x-auto sm:rounded-lg">
    ...
    <div class="w-full min-w-sm">
        <form  method="POST" action="{{ route('admin.residentlist.store') }}" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
            @csrf
