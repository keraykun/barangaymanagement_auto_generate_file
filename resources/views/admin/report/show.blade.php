   ...
   <div class="self-end mr-5">
    <button onclick="printThisFile()" type="button" class="btn bg-blue-500 px-5 hover:bg-blue-600  text-white">Print</button>
        ...
        <div class="flex gap-3" id="printData">
            <div id="printTable" class="card mt-3 flex-1">
                <div class="card-body flex mb-2 items-start flex-col text-2xl">
                    <article class="flex flex-col text-start">
                ...
                <div class="card-body items-start flex justify-start flex-col text-lg">
