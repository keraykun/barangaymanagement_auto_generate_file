    ...
    <section class="flex items-center justify-center flex-1 bg-[url('/public/images/blob2.png')] bg-cover bg-no-repeat bg-center">
        ...
        <div style="z-index: 1; display:flex; justify-content:center; align-items:center;">
            <section style="display:flex; flex-direction:column; flex-wrap:wrap; justify-content:center; align-items:center;">
              <article class="barangay-choose" style="font-size: 2rem;">Create Municipal</article>
              <div class="w-full">
                <form method="POST" action="{{ route('admin.municipal.store') }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    @csrf
                  <div class="mb-4">
                  ...
                  <div class="mb-4">
                    ...
                    <input name="region_name" value="{{ old('region_name') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Ex. Northern Mindanao (Region X)">
                ...
                <div class="mb-4">
                    ...
                    <input name="province_code" value="{{ $municipal}}" readonly class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  id="username" type="text" placeholder="Ex. 101300000">
                  ...
                  {{-- <div class="flex items-center justify-between">
                    ...
                    <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="{{ route('admin.province.show',$id) }}">
                  ...
                  <div class="flex gap-3">
                    <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="{{ route('admin.province.show',$province_id) }}">
                        <i class="fa fa-arrow-left text-3xl"></i>
                       </a>
