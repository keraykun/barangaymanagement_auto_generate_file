...
<div class="relative overflow-x-auto sm:rounded-lg">
    <div class="max-w-[50%] relative">
        <h1 class="my-3 text-2xl font-bold text-slate-600">Update Purok</h1>
        ...
        <form  method="POST" action="{{ route('admin.district.update',$district->id) }}" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
            @csrf
            @method('PATCH')
            <div class="mb-4 flex-1">
                ...
                <input placeholder="Enter Unique" value="{{ $district->name }}" name="name"  class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text">
            ...
            {{-- <div class="mb-4 flex-1">
                ...
                <input placeholder="Enter Unique" value="{{ $district->address }}" name="address"  class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text">
            ...
            <div class="mb-4 flex-1">
                ...
                <input placeholder="Enter Unique" value="{{ $district->zone }}" name="zone"  class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text">
