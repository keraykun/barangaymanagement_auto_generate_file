...
<div class="mb-5 flex flex-col">
    ...
    <a class="px-3 py-2 self-start bg-green-500 text-white hover:bg-green-600" href="{{ route('admin.district.create') }}">New Purok <i class="fa fa-plus font-bold"></i></a>
    @endif
                ...
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    {{-- <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                     ...
                     <th scope="row" class="px-6 py-4 font-medium w-0 text-gray-900 whitespace-nowrap dark:text-white">
                       {{ number_format($district->count) }}
                     </th>
                    <th scope="row" class="hideMe px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <a href="{{ route('admin.resident.show',$district->id) }}" class="gap-2 p-2 rounded-md text-slate-100 bg-green-500"><span class="text-md">View</span></a>
                        @if (auth()->user()->role=='admin' || auth()->user()->role=='secondary')
