...
<div class="mb-5">
    ...
    <div class="text-red-600 text-2xl m-3 w-full text-center">
     ...
     @endif
    <a class="px-3 py-2 bg-green-500 text-white hover:bg-green-600" href="{{ route('admin.position.create') }}">New Official <i class="fa fa-plus font-bold"></i></a>
        ...
        <tbody>
            @foreach ($positions as $position)
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        @if ($position->unique===1)
                            Yes
                        @elseif($position->unique===0)
                            No
                        @endif
                    </th>
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <a href="{{ route('admin.position.edit',$position->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                    </th>
                </tr>
            @endforeach
        </tbody>
