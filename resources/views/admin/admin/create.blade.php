...
<div class="relative overflow-x-auto sm:rounded-lg">
    <div class="w-full min-w-sm">
        <form  method="POST" action="{{ route('admin.admin.store') }}" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
            <div class="flex flex-col gap-4 justify-between">
                ...
                <div class="mb-4 flex-1">
                    ...
                    <input name="email" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text">
                ...
                <div class="mb-4 flex-1">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="username"> Permission Roles  </label>
          ...
          <div class="flex items-center justify-between">
            ...
            <input name="barangay_id" value="{{ $barangay }}" type="hidden">
            @csrf
